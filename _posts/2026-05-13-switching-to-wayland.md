...
GNOME/Mutter developers have made substantially clear their refusal to implement layer-shell protocol (see [issue#1141](https://gitlab.gnome.org/GNOME/gnome-shell/-/work_items/1141)). TL;DR: they want this kind of client to run as GNOME shell extensions.
